...
<li role="presentation"><a href="vista_uasuario.php">  <span class="glyphicon glyphicon-user" aria-hidden="true"></span> Usuarios</a></li>
...
<br>
  ...
  <div class="col-md-9"><ul class="nav nav-pills">
    ...
    <li role="presentation"><a href="Proveedores.php">  <span class="glyphicon glyphicon-user" aria-hidden="true"></span> Proovedores</a></li> 
    <li role="presentation"><a href="ingresar_P.php">  <span class="glyphicon glyphicon-user" aria-hidden="true"></span> Ingresar un nuevo Proveedor</a></li>      
</ul>
<ul class="nav nav-pills nav-stacked">
  ...
  <div class="panel-footer">     <?php
        ...
        for ($j = 0; $j < $num_rows; $j++) {
            ...
            echo '<td>' . $row['telefono_provedor'] . '</td>';
