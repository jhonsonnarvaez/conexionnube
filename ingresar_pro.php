...
mysql_select_db("jm_computer",$conexion);

$pro = "SELECT * FROM producto order by nombre_producto asc"
$query = mysql_query($pro);
...
<br>
  ...
  <div class="col-md-9"><ul class="nav nav-pills">
    ...
    <li role="presentation"><a href="producto.php">  <span class="glyphicon glyphicon-user" aria-hidden="true"></span> Producto</a></li> 
     <li role="presentation"><a href="ingresar_pro.php">  <span class="glyphicon glyphicon-user" aria-hidden="true"></span> Ingresar un nuevo Producto</a></li>    
</ul>
<ul class="nav nav-pills nav-stacked">
  ...
  <div class="panel-footer">       <?php
        ...
        echo '<option value="<?php echo $arreglo["cod_producto"]?>"><?php
        echo $arreglo["nombre_producto"]?></option>';
        }
        echo '</select>';
